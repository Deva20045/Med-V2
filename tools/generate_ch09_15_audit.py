...
Existing Chapter 2–8 visual inventory entries are preserved.  Chapters 9–15 and
...
authored = set(range(9, 16)) | set(range(21, 27))
ledger = [row for row in ledger if row["chapter"] not in authored]

for chapter_number in list(range(9, 16)) + list(range(21, 27)):
...
print(
    ...
    f"({sum(9 <= r['chapter'] <= 15 for r in ledger)} for Chapters 9–15; "
