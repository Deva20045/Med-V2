...
Existing Chapter 2–8 visual inventory entries are preserved.  Chapters 9–32 and
...
Chapter order in the file is the roadmap order, so Chapters 30–32 are written
...
AUTHORED = list(range(9, 21)) + list(range(21, 27)) + list(range(27, 30)) + list(range(30, 33)) + list(range(33, 42)) + list(range(42, 48)) + list(range(48, 51))
...
print(
    ...
    f"{sum(42 <= r['chapter'] <= 47 for r in ledger)} for Chapters 42-47; "
    f"{sum(48 <= r['chapter'] <= 50 for r in ledger)} for Chapters 48-50)."
)
