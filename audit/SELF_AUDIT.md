...
| The medial-surface drawing labels PRECUNEUS above and CUNEUS below the parieto-occipital sulcus, behind the paracentral lobule. | MED-C30-18 |
| The medial figure draws the Calcarine fissure over the LINGUAL GYRUS and shows the hippocampal gyrus ending anteriorly at the labelled uncus, with the fusiform gyrus below it. | MED-C30-19 |
| The orbital figure prints GYRUS RECTUS, then 'Olfactory sulcus' with an arrow, then MED. ORB. GYRUS. | MED-C30-20 |
| The inferior-surface figure prints MED. ORB. GYRUS and LAT. ORB. GYRUS beside the orbital sulcus, with ANTr. ORBITAL GYRUS above and POST. ORB. GYRUS below. | MED-C30-21 |
| The arrow to the orbital sulcus carries the printed note 'Orbital sulcus (H shaped)', with ANTr., POST., MED. and LAT. orbital gyri labelled around it. | MED-C30-22 |
...
| Printed point / call-out | Question |
|---|---|
| The area 4 block opens with 'Only 30% motor fibres originate from here.' | MED-C30-23 |
| 'Betz cells present :' is followed by 'Specialized cells.' and 'Lowest threshold to initiate motor activity.' | MED-C30-24 |
| The third bullet of the area 4 block reads Initiate fine skilled voluntary movement, while planning and finesse are given to the basal ganglia and cerebellum. | MED-C30-25 |
| The PMA and SMA block prints '30% motor fibers originate here.' | MED-C30-26 |
| The preparation list is exactly tone of posture, proximal muscle alignment and antagonist muscle inhibition. | MED-C30-27 |
| The block lists 'B/I lesion spasticity (Tone issue).' with the sub-bullet 'Primitive reflexes.' | MED-C30-28 |
| The ladder begins with Planning and coordination credited to the basal ganglia. | MED-C30-29 |
| The second step of the ladder assigns Prepare (setting up) to PMA/SMA. | MED-C30-30 |
| The ladder ends 'Finesse : by Cerebellum', while Initiation is given to the 1 degree motor area. | MED-C30-31 |
| The homunculus note states 'Face & upper limb : Superolateral surface (supplied by middle Cerebral Artery/MCA).' | MED-C30-32 |
| The left-hand note reads 'Lower limb : medial surface (Supplied by anterior cerebral artery (ACA)).' | MED-C30-33 |
| Along the face region the figure prints Jaw, Tongue, Swallowing and then the arrowed labels MASTICATION, SALIVATION and VOCALIZATION. | MED-C30-34 |
...
| Printed point / call-out | Question |
|---|---|
| The first line under the homunculus continuation reads 'MCA lesion : Face & U/L weakness.' | MED-C30-35 |
| The printed ACA line pairs lower limb weakness with urinary incontinence, the bladder representation being in the paracentral lobule on the medial surface. | MED-C30-36 |
| The ACA line attributes incontinence to the 'paracentral lobule on medial surface'. | MED-C30-37 |
| The list opens 'C/l weakness (Fine skilled voluntary movements).' | MED-C30-38 |
| The second bullet reads 'uMN lesion : Spasticity (Hypertonia).' | MED-C30-39 |
| The page prints 'Fare & upper Limb (Lower limb predominant weakness depending on vessel/side affected) (motor Homunculus)', so dominance is vessel- and side-dependent, never always the leg. | MED-C30-40 |
| The final lesion bullet reads 'Initiate lesion : C/l motor simple partial seizure : Jacksonian march.' (printed as an irritative-type lesion). | MED-C30-41 |
| The last bullet of the lesion block reads 'upper motor Neuron (uMN) : From cortex till anterior horn cell (In grey matter).' | MED-C30-42 |
| The legend lists PPRF - Para Pontine Reticular Formation, LR - Lateral Rectus, MR - medial Rectus and MLF - medial Longitudinal Fasciculus. | MED-C30-43 |
| The legend beside the flowchart reads PPRF - Para Pontine Reticular Formation, alongside LR - Lateral Rectus and MR - medial Rectus. | MED-C30-44 |
| The bullet reads '(L) FEF -> Activates (R) LR & (L) MR -> look to (R).' | MED-C30-45 |
| '(L) FEF lesion -> Cannot look (R) -> patient looks (L) (side of lesion)', concluded as 'Frontal lobe lesion -> Patient look towards side of lesion.' | MED-C30-46 |
| The printed rules contrast a frontal lobe lesion, where the patient looks towards the side of the lesion, with a brainstem PPRF lesion, where the eyes look away from the side of the lesion. | MED-C30-47 |
| The flowchart shows the VI box with a red arrow to 'Right lateral rectus', and PPRF driving VI. | MED-C30-48 |
| The pink highlighted label pointing at that crossing red tract is 'MLF'; the III box in turn points to 'Medial rectus'. | MED-C30-49 |
| The Broca block reads 'Fluency affected (Non fluent aphasia).' | MED-C30-50 |
| The page assigns fluency loss to lesions anterior to the central sulcus and the closing Note assigns comprehension loss to lesions posterior to it. | MED-C30-51 |
...
| Printed point / call-out | Question |
|---|---|
| The page title reads 'pre Frontal Cortex (PFC) / Area. 9, 10, 11, 12 :'. | MED-C30-52 |
| Row one of the table pairs Dorsolateral PFC with 'Executive function'. | MED-C30-53 |
| The table prints 'medial PFC (cingulate gyrus)' against 'Emotion & motivation'. | MED-C30-54 |
| The table assigns executive function to the dorsolateral PFC, while orbital, medial and polar rows are exactly behavioural response, emotion & motivation and theory of mind. | MED-C30-55 |
| The three printed components are cognitive inhibition, response inhibition and set shifting (flexibility); antagonist muscle inhibition belongs to the premotor list on p557. | MED-C30-56 |
| The third bullet reads 'Set shifting (flexibility).' | MED-C30-57 |
| The energisation block prints 'when lost : Apathy (mild) -> Abulia -> Akinetic mutism (severe).' | MED-C30-58 |
| The behavioural response block reads 'Based on reward/punishment.' | MED-C30-59 |
| The list prints 'Includes : JIPFA.' followed by the five expansions. | MED-C30-60 |
| JIPFA expands to Judgement, Insight, Problem solving/personality, Fluency and Abstract thinking. | MED-C30-61 |
| The theory-of-mind bullets read 'Sympathy, empathy.' and 'metacognition : understanding oneself.' | MED-C30-62 |
| The table pairs the Frontal pole with 'Theory of mind', the block that lists sympathy, empathy and metacognition. | MED-C30-63 |
| The B/L FRONTAL LOBE PATHOLOGY list prints 'Primitive reflexes (d/t pre motor cortex involvement).' | MED-C30-64 |
| The list states 'Akinetic mutism : worst form of apathy.' | MED-C30-65 |
| The final bullet reads 'Gait apraxia : Seen in Normal Pressure Hydrocephalus (Ignition failure : Foot feels like stuck to floor).' | MED-C30-66 |
| The MMSE components are printed on p555 as Orientation, Registration, Attention, Recall, Language and Copying, and p559 grades lost energisation as Apathy (mild) -> Abulia -> Akinetic mutism (severe). | MED-C30-67 |
...
| The parietal figure labels the Sylvian fissure and the superior temporal sulcus beneath the inferior parietal lobule, with the parieto-occipital association area highlighted behind them. | MED-C31-06 |
| The three branches read 1 degree sensory cortex (40%), 1 degree motor cortex (30%) and Premotor and supplementary motor cortex (30%). | MED-C31-07 |
| The note gives 30% to the 1 degree motor cortex and 30% to the premotor and supplementary motor cortex. | MED-C31-08 |
| The postcentral gyrus list reads C/L upper motor Neuron (UMN) weakness : middle cerebral artery. | MED-C31-09 |
| The postcentral gyrus list prints tone as less affected and the frontal eye field as spared. | MED-C31-10 |
| The note states 'Association with Pre-motor and Supplementary motor area : Tone, FEF.' | MED-C31-11 |
| The four printed cortical sensations are tactile localization, two point discrimination, stereognosis and graphesthesia; vibration is not listed. | MED-C31-12 |
| Stereognosis, the recognition of an object by touch, is one of the four cortical sensations listed as impaired. | MED-C31-13 |
...
| Printed point / call-out | Question |
|---|---|
| Under SUPERIOR PARIETAL LOBULE the text reads 'generate Praxicons : movement formula/sensory guidance for movement.' | MED-C31-14 |
| Apraxia is defined as 'Inability to execute a learnt voluntary skilled action despite normal cerebellum, motor & sensory function and comprehension.' | MED-C31-15 |
| The second bullet reads 'Lesion in SPL : Inability to generate praxicons.' | MED-C31-16 |
| The types are printed as 'Ideational apraxia : Idea absent.' and 'Ideomotor apraxia : Idea present -> Execution poor.' | MED-C31-17 |
| Under Supramarginal gyrus the text reads 'gnosis : Ability to recognize object by touch/vision/sound.' | MED-C31-18 |
| The visual agnosia block reads 'Inability to identify by vision' with areas 'Supramarginal gyrus' and 'Parieto-occipital association area : Visuospatial orientation'. | MED-C31-19 |
| The figure labels 'Parieto-occipital association area : Visuospatial orientation' beside the parieto-occipital region. | MED-C31-20 |
| The printed captions under the four drawings are snake, stereo or computer, bug and lamp; spider is not one of them. | MED-C31-21 |
| The table prints Right handed as right lobe 5% and left lobe 90-95%. | MED-C31-22 |
| The second table row prints Left handed: right lobe 40% and left lobe 50-60%. | MED-C31-23 |
| Beneath the handedness table the line reads 'Language is part of dominant lobe.' | MED-C31-24 |
| The non-dominant parietal lobe heading lists pseudoapraxia with constructional apraxia and dressing apraxia, the latter illustrated by being unable to put on a jacket. | MED-C31-25 |
| The bullet reads 'Constructional apraxia : Inability to perceive and imagine geometric relation.' | MED-C31-26 |
| The last bullet of the page defines visuospatial disorientation as the inability to differentiate places, illustrated by the bedroom and bathroom example. | MED-C31-27 |
...
| Printed point / call-out | Question |
|---|---|
| The bullet reads 'Hemispatial neglect (Anosognosia/Asomatognosia) : visual scanning (Body schema) -> Neglect of activities related to one of the hemispheres.' | MED-C31-28 |
| The printed gloss is 'visual scanning (Body schema)' before the neglect definition. | MED-C31-29 |
| The table prints left parietal extrapersonal space as 'Right' and its lesion row as 'No abnormality', so neglect of the right field is not a left parietal sign. | MED-C31-30 |
| The right parietal column lists the lesion row as 'Left hemispatal neglect' (as printed). | MED-C31-31 |
| The bullet reads 'Topographic agnosia : Loss of orientation to topography.' | MED-C31-32 |
| The flower and clock drawings on the right of the page are captioned Hemispatial neglect, while the copied geometric figures are captioned Constructional apraxia By patient. | MED-C31-33 |
| The left-hand drawing is labelled as the Rey-Osterrieth Complex Figure (ROCF) figure versus patient, with the A1, A2 and A3 patient copies beneath it. | MED-C31-34 |
| The functions column prints Reading, Writing, Naming and 'Spatial orientation with respect to finger, number, body sites'; calculation appears only as acalculia in Gerstman syndrome. | MED-C31-35 |
| The fourth function bullet reads 'Spatial orientation with respect to finger, number, body sites.' | MED-C31-36 |
| The Gerstman column opens 'Lesion of dominant angular gyrus.' | MED-C31-37 |
| The printed syndrome lists alexia with agraphia, anomia and finger anomia/acalculia/right-to-left disorientation; limb-kinetic apraxia is not named. | MED-C31-38 |
| The note reads 'Left Posterior Cerebral Artery (PCA) Infarct + Splenium of corpus callosum', with the disconnection arm giving 'Alexia without agraphia'. | MED-C31-39 |
| The right-hand branch states 'Disconnection syndrome (Loss of connection between cortices).' | MED-C31-40 |
| The branch prints 'Vision normal (macular sparing)' and 'C/L (Right) homonymous hemianopia'. | MED-C31-41 |
| The bullet reads 'Pure Alexia : Lesion of fusiform gyrus.' | MED-C31-42 |
| The list prints frontal lobe as C/L hemianopia, parietal as inferior quadrantanopia (pie in floor) and temporal as superior quadrantanopia (pie in sky). | MED-C31-43 |
| The printed table assigns the temporal lobe 'U/L superior homonymous quadrantanopia (Pie in sky)', the parietal lobe the pie-in-floor counterpart and the frontal lobe a C/L hemianopia. | MED-C31-44 |
